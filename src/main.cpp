...
const double safe_distance_from_other_vehicle = 20.0;
          ...
          // j[1] is the data JSON object
			...
			if (should_change_lane)
			{
				for (int i = 0; i < number_of_other_vehicles; ++i) 
				{
					...
					{
						vehicle.s += prev_size * 0.02 * vehicle.speed;
						bool too_close_to_change = (vehicle.s > car_s - safe_distance_from_other_vehicle / 2) && (vehicle.s < car_s + safe_distance_from_other_vehicle / 2);
